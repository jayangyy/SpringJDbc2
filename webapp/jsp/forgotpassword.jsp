...
<div id="logo"> 
      ...
      <div id="col_wrap4">
          ...
          <div id="banner" >
              <img src="${pageContext.request.contextPath}/img/frontpage/forgotpassword.gif" alt="欢迎体验七巧板框架" /> 
...
<div id="content">
    ...
    <div class="colx2"> 
        ...
        <h2>忘记您的密码了吗？</h2>
        <div><p>请提供一个用户名(用户ID)或您注册账号时的邮箱地址！</p>
			<p>我们会发送Email以允许你重新设置您的密码！请稍后查看您的邮箱并点击邮箱内容中的链接地址，以定位到密码重设页面。</p>
        </div>    
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
				  ...
				  <tr>
					<td colspan="2" style="text-align: right;"><br/>
						...
						<input name="sendEmail" value="发送邮件信息" type="submit" />
					</td>
				  </tr>
				</table>
		   </form>
    ...
    <table><tr>
    <td>
    	<A href="" target=_top>相关下载</A>  |  <A href="http://www.blogjava.net/SpartaYew">我们的WEB</A>  |  
