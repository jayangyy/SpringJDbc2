public class Five extends Root //сруш
{
	...
	public boolean begin()
	{
		if((gTable.myTable[(gTable.x-1)/2][0]==0)&&(gTable.myTable[(gTable.x-1)/2][1]==0)&&
			(gTable.myTable[(gTable.x-1)/2][2]==0)&&(gTable.myTable[(gTable.x-1)/2+1][0]==0))
		{
			x=(gTable.x-1)/2;
			y=0;
			gTable.myTable[x][y]=5;
			gTable.myTable[x][y+1]=5;
			gTable.myTable[x][y+2]=5;
			gTable.myTable[x+1][y]=5;
			return true;
		}
		else
		{
		...
		switch(direct)
		{
                	case 1:if(y<=gTable.y-4)
			       {
					...
					store[1]=gTable.myTable[x+1][y+1];
						...
						gTable.myTable[x][y+3]=5;
						gTable.myTable[x+1][y+1]=5;
						y+=1;
						return true;
			      		 }
			      		 else
			...
			case 2:if(x<=gTable.x-4)
				{
					...
					store[1]=gTable.myTable[x+3][y+1];
						...
						gTable.myTable[x][y]=0;
						gTable.myTable[x+2][y+1]=0;
						gTable.myTable[x+3][y]=5;
						gTable.myTable[x+3][y+1]=5;
						x+=1;
						return true;
			   		}
					else
	...
	public boolean change()
	{
		switch(direct)
		{
			case 1:if(x<=gTable.x-3)
				{
			      	 	store[0]=gTable.myTable[x+1][y+1];
			       		store[1]=gTable.myTable[x+1][y+2];
			       		store[2]=gTable.myTable[x+2][y];
			       		store[3]=gTable.myTable[x+2][y+1];
					store[4]=gTable.myTable[x+2][y+2];
			       		if(isGo(5))
			       		{
						gTable.myTable[x][y]=0;
						gTable.myTable[x+1][y]=0;
			...
			case 2:if(true)
				{
			       		...
			       		store[3]=gTable.myTable[x][y+1];
					store[4]=gTable.myTable[x+1][y+1];
			       		if(isGo(5))
			      		 {
						gTable.myTable[x][y]=0;
						gTable.myTable[x+2][y]=0;
